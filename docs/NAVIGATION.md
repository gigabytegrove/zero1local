...
- **Install & start:** [Getting Started](GETTING-STARTED.md) · [Installation](INSTALLATION.md) · [Upgrading](UPGRADING-AND-ROLLBACK.md)
- **Storage/files:** [Storage & RAID](STORAGE-AND-RAID.md) · [Files/Users/Shares](FILES-USERS-AND-SHARES.md) · [SMB/NFS](SMB-AND-NFS.md) · [File Manager](FILE-MANAGER.md)
- **Phones/tasks:** [Phone Transfer](PHONE-TRANSFER.md) · [Task Center](TASK-CENTER.md) · [LED Status](LED-STATUS.md)
